...
- 新增首次安装欢迎页，展示核心功能、默认规则演示和快捷入口
- 新增国际化支持（中/英文），配置项描述和欢迎页文案均支持多语言
- `dot-anything.rules` 新增默认规则（`log`、`//`），开箱即用
- `README_CN.md` 重命名为 `README.zh-CN.md`

详见 [doc/plan/1.5.0-欢迎页与国际化.md](doc/plan/1.5.0-欢迎页与国际化.md)
